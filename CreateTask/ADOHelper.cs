...
namespace TimeTracker
{
    public class ADOHelper
    {
        ...
        private async Task<System.Collections.Generic.IList<WorkItem>> _GetItemInfo(int itemId)
        {
            ...
            try
            {
                ...
                using (var httpClient = new WorkItemTrackingHttpClient(uri, credentials))
                {
                    ...
                    // build a list of the fields we want to see
                    var fields = new[] { "System.Id", "System.WorkItemType", "System.Title", "System.State", "System.AreaPath", "System.IterationPath", "System.Tags", "Microsoft.VSTS.Scheduling.OriginalEstimate" };
        ...
        public async Task UpdateTaskAsync(ADOTask updateEntry)
        {
            ...
            double existingEstimate= await GetOriginalEstimateAsync(updateEntry.Id);
            existingEstimate += updateEntry.OriginalEstimate;
        ...
        private async Task<double> GetOriginalEstimateAsync(int itemId)
        {
            string originalEstimate = "0";
            ...
            if (itemId > 0)
            {
                ...
                {
                    originalEstimate = workItems[0].Fields["Microsoft.VSTS.Scheduling.OriginalEstimate"].ToString();
                }
            }
            return Convert.ToDouble(originalEstimate);
        }
